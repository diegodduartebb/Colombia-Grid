...
#⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡎⠀⡜⠁⠀⢀⠎⠀⠀⠀⠀⠈⢆⠀⠀⠀⠀⣀⠤⡭⣙⠶⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀#
#⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀#
#⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀  Juan Diego Duarte - Rstudio 4.3.1    ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀##
##⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀       Ultima modificación: 19 de Mayo de 2025     ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀##
##⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀  FAHNHEIT ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀##
##⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀##
##⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀##
######################################################################################################################
#### COMO USAR:
#### 0- Correr todo el codigo de este script.
#### Dentro del script que se este usando de manera personal:
#### 1- Importar el municipioscol.csv creado con este script como "df_final". Importar el municipioscol_labels.csv
####    creado con este script como "df_depto_labels".
#### 2- Hacer un merge entre df_final y la base de datos municipal que se este construyendo o usando.
#### 3- Escoger si graficar con o sin etiquetas departamentales, copiar el codigo que corresponda (se encuentra dentro 
####    de las cajas con *** en este script) y pegar el codigo dentro del script personal.
#### 4- Cambiar la opción fill del grafico por el nombre de la variable a graficar.
#### 5- Editar el estilo y ruta de donde guardar el grafico.
######################################################################################################################
##### SET PAQUETES
######################################################################################################################
...
p_load(dplyr, sf, ggplot2, tidyverse)
...
mapa_colombia <- st_read("Bases/adminisitrativo_muncol/MGN_MPIO_POLITICO.shp")
...
# ************** COPIAR **********************************
# ************************************************
grilla <- ggplot(df_final, aes(x = global_col, y = -global_row, fill = variable)) +
  geom_tile(color = "white") +
  coord_fixed() +
  theme_void() +
  labs(title = "Mapa de cuadrículas con offsets manuales Municipios Colombia",
       fill = "Variable") +
  theme(legend.position = "bottom")

ggsave("Resultados/Grilla/grilla.png", grilla)
# ************************************************
# ************************************************
...
# ************** COPIAR **********************************
# ************************************************
mapa_dep <- ggplot(df_final, aes(x = global_col, y = -global_row, fill = variable)) +
  geom_tile(color = "white") +
  # Etiquetas de departamentos
  geom_label(
    data = df_depto_labels,
    inherit.aes = FALSE,
    aes(x = centro_col, y = -centro_row, label = DPTO_CNMBR),
    color = "black",
    fill = "white",   # fondo blanco
    size = 0.8,
    label.size = 0,   # grosor del borde del recuadro
    alpha = 0.4       # transparencia del fondo
  ) +
  coord_fixed() +
  theme_void() +
  labs(title = "Mapa de los Municipios de Colombia",
       fill = "Variable") +
  theme(legend.position = "bottom")

ggsave("Resultados/Grilla/grilla_deps.png", mapa_dep)
# ************************************************
# ************************************************
...
write.csv(df_final, "Resultados/Grilla/municipioscol.csv")
write.csv(df_depto_labels, "Resultados/Grilla/municipioscol_labels.csv")
